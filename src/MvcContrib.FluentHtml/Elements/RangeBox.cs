...
{
	/// <summary>
	/// Generate an HTML input element of type 'range.'
	/// </summary>
	public class RangeBox : RangeBoxBase<RangeBox>
	{
		/// <summary>
		/// Generate an HTML input element of type 'range.'
		/// </summary>
		/// <param name="name">Value of the 'name' attribute of the element.  Also used to derive the 'id' attribute.</param>
		public RangeBox(string name) : base(name) {}
		...
		public RangeBox(string name, MemberExpression forMember, IEnumerable<IBehaviorMarker> behaviors) 
