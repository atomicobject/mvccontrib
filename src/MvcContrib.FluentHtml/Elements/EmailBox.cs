...
{
	/// <summary>
	/// Generate an HTML input element of type 'email.'
	/// </summary>
	public class EmailBox : EmailBoxBase<EmailBox>
	{
		/// <summary>
		/// Generate an HTML input element of type 'email.'
		/// </summary>
		/// <param name="name">Value of the 'name' attribute of the element.  Also used to derive the 'id' attribute.</param>
		public EmailBox(string name) : base(name) { }
		...
		public EmailBox(string name, MemberExpression forMember, IEnumerable<IBehaviorMarker> behaviors)
