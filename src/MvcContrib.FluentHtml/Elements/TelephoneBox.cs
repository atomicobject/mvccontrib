...
{
	/// <summary>
	/// Generate an HTML input element of type 'tel.'
	/// </summary>
	public class TelephoneBox : TelephoneBoxBase<TelephoneBox>
	{
		/// <summary>
		/// Generate an HTML input element of type 'tel.'
		/// </summary>
		/// <param name="name">Value of the 'name' attribute of the element.  Also used to derive the 'id' attribute.</param>
		public TelephoneBox(string name) : base(name) { }
		...
		public TelephoneBox(string name, MemberExpression forMember, IEnumerable<IBehaviorMarker> behaviors)
