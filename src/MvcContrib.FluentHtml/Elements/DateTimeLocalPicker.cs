...
{
	/// <summary>
	/// Generate an HTML input element of type 'datetime-local.'
	/// </summary>
	public class DateTimeLocalPicker : DateTimeLocalPickerBase<DateTimeLocalPicker>
	{
		/// <summary>
		/// Generate an HTML input element of type 'datetime-local.'
		/// </summary>
		/// <param name="name">Value of the 'name' attribute of the element.  Also used to derive the 'id' attribute.</param>
		public DateTimeLocalPicker(string name) : base(name) { }
		...
		public DateTimeLocalPicker(string name, MemberExpression forMember, IEnumerable<IBehaviorMarker> behaviors)
