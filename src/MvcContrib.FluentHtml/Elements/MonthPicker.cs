...
{
	/// <summary>
	/// Generate an HTML input element of type 'month.'
	/// </summary>
	public class MonthPicker : MonthPickerBase<MonthPicker>
	{
		/// <summary>
		/// Generate an HTML input element of type 'month.'
		/// </summary>
		/// <param name="name">Value of the 'name' attribute of the element.  Also used to derive the 'id' attribute.</param>
		public MonthPicker(string name) : base(name) { }
		...
		public MonthPicker(string name, MemberExpression forMember, IEnumerable<IBehaviorMarker> behaviors)
