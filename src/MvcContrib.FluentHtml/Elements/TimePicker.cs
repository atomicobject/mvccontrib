...
{
	/// <summary>
	/// Generate an HTML input element of type 'time.'
	/// </summary>
	public class TimePicker : TimePickerBase<TimePicker>
	{
		/// <summary>
		/// Generate an HTML input element of type 'time.'
		/// </summary>
		/// <param name="name">Value of the 'name' attribute of the element.  Also used to derive the 'id' attribute.</param>
		public TimePicker(string name) : base(name) { }
		...
		public TimePicker(string name, MemberExpression forMember, IEnumerable<IBehaviorMarker> behaviors)
