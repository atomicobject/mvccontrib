...
{
	/// <summary>
	/// Generate an HTML input element of type 'week.'
	/// </summary>
	public class WeekPicker : WeekPickerBase<WeekPicker>
	{
		/// <summary>
		/// Generate an HTML input element of type 'week.'
		/// </summary>
		/// <param name="name">Value of the 'name' attribute of the element.  Also used to derive the 'id' attribute.</param>
		public WeekPicker(string name) : base(name) { }
		...
		public WeekPicker(string name, MemberExpression forMember, IEnumerable<IBehaviorMarker> behaviors)
